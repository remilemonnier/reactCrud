...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsUserJsx = __webpack_require__(1);

	var _jsUserJsx2 = _interopRequireDefault(_jsUserJsx);

	var _jsNewUserJsx = __webpack_require__(216);

	var _jsNewUserJsx2 = _interopRequireDefault(_jsNewUserJsx);

	var _jsUserListJsx = __webpack_require__(218);

	var _jsUserListJsx2 = _interopRequireDefault(_jsUserListJsx);

	var _jsHomeJsx = __webpack_require__(219);

	var _jsHomeJsx2 = _interopRequireDefault(_jsHomeJsx);
	    ...
	    render: function render() {
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                'td',
	                null,
	                _react2['default'].createElement('img', { src: this.props.picture.thumbnail, height: '40', width: '40' })
	            ),
	            _react2['default'].createElement(
	                'td',
	                null,
	            ...
	            _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    _reactRouter.Link,
	                    { to: '/user/edit/' + this.props.id, className: 'btn btn-sm btn-primary' },
	                    'Edit'
	                ),
	                _react2['default'].createElement(
	                    _reactRouter.Link,
	                    { to: '/user/delete/' + this.props.id, className: 'btn btn-sm btn-danger' },
	                    'Delete'
	                )
	            )
	        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _userJsx = __webpack_require__(1);

	var _userJsx2 = _interopRequireDefault(_userJsx);

	var _userListJsx = __webpack_require__(218);
	...
	var newUser = _react2['default'].createClass({
	    ...
	    createUser: function createUser(event) {
	        ...
	        var user = {
	            ...
	            phone: _reactDom2['default'].findDOMNode(this.refs.phone).value,
	            picture: {
	                large: null,
	                medium: null,
	                thumbnail: null
	    ...
	    getInitialState: function getInitialState() {
	        ...
	        if (parseInt(id) > 0) {
	            var user = _userJsx2['default'].getUser(id);
	        } else {
	            var user = {
	                username: '',
	                email: '',
	    ...
	    render: function render() {
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                ...
	                _react2['default'].createElement('input', { type: 'text', ref: 'username', id: 'username', placeholder: 'Username', value: this.state.username, onChange: this.onChange }),
	                _react2['default'].createElement(
	                    'label',
	                    { 'for': 'email' },
	                    'Email'
	                ),
	                _react2['default'].createElement('input', { type: 'email', ref: 'email', id: 'email', placeholder: 'email', value: this.state.email, onChange: this.onChange }),
	                _react2['default'].createElement(
	                    'label',
	                    { 'for': 'password' },
	                    'Password'
	                ),
	                _react2['default'].createElement('input', { type: 'password', ref: 'password', id: 'password', placeholder: 'password', value: this.state.password, onChange: this.onChange }),
	                _react2['default'].createElement(
	                    'label',
	                    { 'for': 'phone' },
	                    'Phone'
	                ),
	                _react2['default'].createElement('input', { type: 'text', ref: 'phone', id: 'phone', placeholder: 'phone', value: this.state.phone, onChange: this.onChange })
	            ),
	            _react2['default'].createElement(
	                'p',
	                null,
	                ...
	                _react2['default'].createElement(
	                    _reactRouter.Link,
	                    { to: '/', className: 'btn btn-sm btn-primary' },
	                    'Cancel'
	                )
	            )
	        );
	...
	var UserList = _react2['default'].createClass({
	    ...
	    render: function render() {
	        var users = this.props.users.map(function (p) {
	            return _react2['default'].createElement(_userJsx2['default'], { username: p.username, email: p.email, phone: p.phone, picture: p.picture, id: p.id, key: p.id });
	        });
	        return _react2['default'].createElement(
	            'div',
	            null,
	            ...
	            _react2['default'].createElement(
	                _reactRouter.Link,
	                { to: '/user/add', className: 'btn btn-sm btn-success' },
	                'Add'
	            ),
	            _react2['default'].createElement(
	                'table',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _newUserJsx = __webpack_require__(216);

	var _newUserJsx2 = _interopRequireDefault(_newUserJsx);

	var _deleteUserJsx = __webpack_require__(220);

	var _deleteUserJsx2 = _interopRequireDefault(_deleteUserJsx);
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                'div',
	                { id: 'hp' },
	                _react2['default'].createElement(_userListJsx2['default'], { users: this.state.users })
	            ),
	            this.props.children
	        );
	    }
	...
	_reactDom2['default'].render(_react2['default'].createElement(
	    ...
	    _react2['default'].createElement(_reactRouter.Route, { path: '/user/add', component: _newUserJsx2['default'] }),
	    _react2['default'].createElement(_reactRouter.Route, { path: '/user/edit/:id', component: _newUserJsx2['default'] }),
	    _react2['default'].createElement(_reactRouter.Route, { path: '/user/delete/:id', component: _deleteUserJsx2['default'] })
	), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useBasename2 = __webpack_require__(209);
	...
	var _useQueries2 = __webpack_require__(178);

	var _useQueries3 = _interopRequireDefault(_useQueries2);

	exports.useQueries = _useQueries3['default'];

	var _Actions2 = __webpack_require__(164);
	...
	var _enableBeforeUnload2 = __webpack_require__(223);

	var _enableBeforeUnload3 = _interopRequireDefault(_enableBeforeUnload2);

	exports.enableBeforeUnload = _enableBeforeUnload3['default'];

	var _enableQueries2 = __webpack_require__(224);
